...
# app = Flask(__name__, static_folder="../bostonHarborFE/build")
# app = Flask(__name__)
...
def email_verification():
    try:
        ...
        sign_up_link = f"https://wealth-management.mresult.net/signUp/{email}"
...
def advisor_profile():
    if request.method == 'GET':
        ...
        try:
            ...
            client_data_url = 'https://wealth-management.mresult.net/api/get-all-client-data'
